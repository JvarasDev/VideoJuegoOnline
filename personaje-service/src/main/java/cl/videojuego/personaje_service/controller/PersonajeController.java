...
@Tag(
        name = "Personajes",
        description = "API para la gestión de personajes del videojuego"
)
public class PersonajeController {
    ...
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Personajes listados correctamente",
                    content = @Content(
   ...
   // Registar nuevo personaje
    @Operation(
            ...
            description = "Permite crear un nuevo personaje asociado a un usuario existente. Antes de registrar, el microservicio valida mediante OpenFeign que el usuario exista, no esté baneado, no esté suspendido y no tenga rol administrador."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
                    description = "Personaje registrado correctamente",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = PersonajeDTO.class)
                    )
            ...
            @ApiResponse(
                    responseCode = "404",
                    description = "Usuario, clase o estado no encontrado",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "409",
                    description = "Usuario no apto para crear personaje",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "500",
    ...
    public ResponseEntity<PersonajeDTO> registrar(
        ...
        return ResponseEntity
                ...
                .body(personajeService.registrar(dto));
    }

    // Listar clases de personajes
    @Operation(
            summary = "Listar clases de personaje",
    ...
    @ApiResponses({
            @ApiResponse(
                    ...
                    content = @Content(
                            mediaType = "application/json",
                            array = @ArraySchema(
                                    schema = @Schema(implementation = ClasePersonaje.class)
                            )
                    )
            ),
            @ApiResponse(
    ...
    //Listar Estados de personajes
    @Operation(
            summary = "Listar estados de personaje",
    ...
    @ApiResponses({
            @ApiResponse(
                    ...
                    content = @Content(
                            mediaType = "application/json",
                            array = @ArraySchema(
                                    schema = @Schema(implementation = EstadoPersonaje.class)
                            )
                    )
            ),
            @ApiResponse(
    ...
    // Listar personajes por usuarios
    @Operation(
            summary = "Listar personajes por usuario",
            description = "Retorna todos los personajes asociados a un usuario específico."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Personajes del usuario listados correctamente",
                    content = @Content(
                            mediaType = "application/json",
                            array = @ArraySchema(
                                    schema = @Schema(implementation = PersonajeDTO.class)
    ...
    public ResponseEntity<List<PersonajeDTO>> listarPorUsuario(
            @Parameter(
                    description = "Identificador del usuario propietario de los personajes",
                    example = "1"
            )
    ...
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Personajes por nivel listados correctamente",
                    content = @Content(
                            mediaType = "application/json",
                            array = @ArraySchema(
                                    schema = @Schema(implementation = PersonajeDTO.class)
    ...
    // Listar  personaje por clase
    @Operation(
            summary = "Listar personajes por clase",
            description = "Retorna personajes filtrados por clase de personaje."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Personajes por clase listados correctamente",
                    content = @Content(
                            mediaType = "application/json",
                            array = @ArraySchema(
                                    schema = @Schema(implementation = PersonajeDTO.class)
    ...
    public ResponseEntity<List<PersonajeDTO>> listarPorClase(
            @Parameter(
                    description = "Identificador de la clase del personaje",
                    example = "1"
            )
    ...
    // Listar personaje por estado
    @Operation(
            summary = "Listar personajes por estado",
            description = "Retorna personajes filtrados por estado."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "Personajes por estado listados correctamente",
                    content = @Content(
                            mediaType = "application/json",
                            array = @ArraySchema(
                                    schema = @Schema(implementation = PersonajeDTO.class)
    ...
    public ResponseEntity<List<PersonajeDTO>> listarPorEstado(
            @Parameter(
                    description = "Identificador del estado del personaje",
                    example = "1"
            )
